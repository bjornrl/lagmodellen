...
export const principles: Principle[] = [
  ...
  },
  {
    ...
    mobExperience:
      "Beslutninger tatt raskere med tre aktører tett sammen. Redusert dobbeltarbeid.",
    reflection: [
  ...
  },
  {
    ...
    short:
      "Faste sammensetninger av ansatte, med deltidsstillinger og tydelig tilhørighet.",
    description:
      "Stabil sammensetning, innbygger møter samme personer gjennom hele oppfølgingen.",
  ...
  },
  {
    ...
    short:
      "Innbyggeren opplever hjelpen som ett helhetlig tilbud, med enkel inngang.",
    description:
      "Én inngang, én plan, én vei videre — uavhengig av antall aktører.",
  ...
  },
  {
    ...
    color: "tertiary-mint",
    short:
      "Oppfølgingen skal som hovedregel utføres fra samme sted.",
    description:
    ...
    mobExperience:
      "Raske avklaringer mellom møtene. Saker løst på minutter. Færre misforståelser.",
    reflection: [
  ...
  },
  {
    ...
    color: "tertiary-pink",
    short:
      "Oppfølging skjer på innbyggerens eget initiativ og ønske.",
...
export const steps: Step[] = [
  {
    ...
    citizenNotices:
      "Lite foreløpig, men forventningsstyring forberedes.",
  },
  {
    number: 2,
    ...
    actions:
      "Velg én målgruppe der fragmentering merkes. Definer inn- og ut-kriterier.",
    clarifications: "Målgruppebeskrivelse, etikk-sjekk, plan for inngang.",
    pitfalls: "Uklare grenser, for bred målgruppe.",
    citizenNotices:
      "Klart budskap om hvem tilbudet gjelder, at det er frivillig.",
  },
  {
    number: 3,
    ...
    actions:
      "2–3 offentlige tjenester + 1 frivillig/ideell. Rolleavklaringer. Avklar tid.",
  ...
  },
  {
    ...
    actions:
      "Ett kontaktpunkt, ukentlig inntaksmøte, standardisert mottak.",
  ...
  },
  {
    ...
    actions:
      "Kjøreregler på én side. Beslutninger i laget, én plan, faste deltakere.",
  ...
  },
  {
    ...
    actions:
      "Journalfør hver for dere. Del med samtykke. Avklar hvert møte hva som kan deles.",
  ...
  },
  {
    ...
    actions:
      "Ukentlig lagmøte, felles tavle, faste tider, samlokalisering.",
  ...
  },
  {
    ...
    actions:
      "Velg 3–5 saker. Forventningssamtale. Avklar roller. Innhent samtykke.",
    clarifications:
      "Mal for forventningssamtale, målnotat, samtykkeskjema.",
    pitfalls: "Tiltak uten felles mål.",
    citizenNotices:
      "Mål formulert i eget språk, én plan, frivillighet bekreftet.",
  },
  {
    number: 9,
  ...
  },
  {
    ...
    actions:
      "Vurder kapasitet, støtte, etterspørsel, samarbeid. Fortsett, juster eller stopp.",
  ...
  },
  {
    ...
    actions:
      "Trinnvis. Øk volum i samme målgruppe før utvidelse. Prinsippsjekk ved utvidelse.",
...
export const barriers: Barrier[] = [
  ...
  },
  {
    ...
    description:
      "Journalplikt, finansieringsmodeller skaper usikkerhet.",
    solution: "Faste relasjoner og tillit løser.",
  },
  {
    title: "Lederforankring",
    description:
      "Uten lederstøtte vanskelig å holde retning.",
  ...
  },
  {
    ...
    solution:
      "Prinsippene om faste relasjoner, samlokalisering og enkel inngang.",
  },
  {
    title: "Kulturforskjeller",
    description: "Ulike fagkulturer.",
    solution:
      "Tverrsektorielle lag og samlokalisering bygger kultur.",
  },
];
...
export const mannOmBordCase: MannOmBordCase = {
  ...
  results: {
    innbyggere:
      "Trygghet, lavere terskel for hjelp, bedre livskvalitet.",
    ansatte:
      "Høyere arbeidsglede, lavere sykefravær, bedre støtte.",
    organisasjoner:
      "Effektivt samarbeid, redusert dobbeltarbeid, raskere beslutninger.",
  },
  patterns:
...
export const systemChallenges: SystemChallenge[] = [
  {
    ...
    description:
      "Innbyggere møter mange aktører og må koordinere hjelpen selv.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Ansatte bruker tid på å få systemet til å henge sammen.",
  },
  {
    title: "Manglende brobygging",
    description:
      "Ulike fagkulturer, styringsnivåer og regelverk skaper barrierer.",
  },
];
...
export const changeReactions: ChangeReaction[] = [
  {
    ...
    label: "Mikro (individ)",
    description:
      "Nysgjerrighet blandet med usikkerhet om egen rolle.",
  },
  {
    level: "meso",
...
export const teamVariants: TeamVariant[] = [
  {
    ...
    description:
      "Offentlige tjenester bærer mest kapasitet, ideell/frivillig styrker relasjon.",
  },
  {
    title: "Ideell/frivillig-tyngde",
    description:
      "Frivillig leder relasjon og nærvær, offentlige avklarer rettigheter.",
  },
  {
